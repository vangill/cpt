...
$share_network = array(
	...
	'googleplus'    => esc_attr__( 'Google+ ( Deprecated )', 'jnews-social-share' ),
	...
	'telegram'      => esc_attr__( 'Telegram', 'jnews-social-share' ),
	...
	'odnoklassniki' => esc_attr__( 'Odnoklassniki', 'jnews-social-share' ),
);
...
$options[] = array(
	...
	'description' => sprintf( __( 'Get your Facebook Access Token by clicking this <a class="%1$s" href="%2$s" target="_blank">link</a>.<span class="jnews-spinner spinner"></span>', 'jnews' ), 'jnews_token_access facebook', '#' ),
);
