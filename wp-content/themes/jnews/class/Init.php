...
class Init {
	...
	public function verify_dark_mode() {
		if ( get_theme_mod( 'jnews_dark_mode_options' ) && ! get_theme_mod( 'jnews_already_check_dark_mode', false ) ) {
			if ( 'jeg_toggle_dark' === get_theme_mod( 'jnews_dark_mode_options' ) ) {
				set_theme_mod( 'jnews_dark_mode_options', 'jeg_toggle_light' );
				set_theme_mod( 'jnews_already_check_dark_mode', true );
			}
		}
	}
}
